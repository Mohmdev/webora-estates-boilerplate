					...
					<div className="row log-in">
						...
						<div className="col-xl-9 col-lg-8 col-12">
							<div className="theme-card">
								<h2>Privacy policy for Webora Estates</h2>
								<div className="terms-wrap">
									<div className="terms-wrapper">
										<p>
											At Webora Estates, accessible at realestate.webora.app,
											one of our main priorities is the privacy of our visitors.
											This Privacy Policy document contains types of information
											that is collected and recorded by Webora Estates and how
											we use it.
										</p>
										<p>
											...
											<a href="mailto:info@webora.app">info@webora.app</a>
										</p>
									</div>
									...
									<div className="terms-wrapper" id="thirdparty">
										...
										<p>
											Webora Estates&apos;s Privacy Policy does not apply to
									...
									<div className="terms-wrapper" id="advertising">
										...
										<p>
											...
											each of the advertising partners of Webora Estates.
										</p>
										<p>
											...
											Website Name, which are sent directly to users&apos;
											browser.{" "}
										</p>
										<p>
											Note that Webora Estates has no access to or control over
